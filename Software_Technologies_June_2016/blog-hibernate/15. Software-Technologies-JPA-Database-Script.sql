...
-- Dumping database structure for javablogdb
DROP DATABASE IF EXISTS `javablogdb`;
CREATE DATABASE IF NOT EXISTS `javablogdb` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `javablogdb`;

-- Dumping structure for table javablogdb.comments
...
CREATE TABLE IF NOT EXISTS `comments` (
  ...
  CONSTRAINT `authorid` FOREIGN KEY (`author_id`) REFERENCES `users` (`id`),
  CONSTRAINT `postid` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8;

-- Dumping data for table javablogdb.comments: ~37 rows (approximately)
DELETE FROM `comments`;
/*!40000 ALTER TABLE `comments` DISABLE KEYS */;
INSERT INTO `comments` (`id`, `text`, `post_id`, `author_id`, `author_name`, `date`) VALUES
	(1, 'I\'m reading all of your posts, and each of them is more interesting. I will continue to follow you and read everything you post on your blog.', 1, NULL, 'Isaac Netero', '2015-02-11 00:00:00'),
	(2, 'This blog is a gold mine. It is simply amazing. I am very curious to how this blog remained hidden from me for so long. I will be following it every day, from now on.', 1, 4, NULL, '2016-03-25 00:00:00'),
	(3, 'Another awesome post... I am indeed amazed by how great your posts are. Keep up the awesome work.', 2, NULL, 'Isaac Netero', '2015-02-02 00:00:00'),
	(4, 'How will you interprete the problems you\'ve faced in the Customer Services? Do you have an answer or an assumption to why they are existent?', 2, 15, NULL, '2016-05-30 00:00:00'),
	(5, 'The hype is strong in this one...', 7, NULL, 'Pesho Peshov', '2016-06-14 00:00:00'),
	(6, 'Quite a nice post I must say. However the answers to the questions are not very clear. Can you provide us with better answers.', 7, 4, NULL, '2016-06-24 00:00:00'),
	(7, 'The real is strong in this one.', 7, 7, NULL, '2016-07-11 00:00:00'),
	(8, 'I will be following your posts, for the future. They seem quite intriguing.', 7, NULL, 'Isaac Netero', '2016-07-11 00:00:00'),
	(9, 'Well, I am off to finding my dream wife.', 8, NULL, 'Pesho Peshov', '2016-06-14 00:00:00'),
	(10, 'This is a very relative topic. A lot of questions and arguments are orbiting arround it.', 8, 5, NULL, '2016-06-24 00:00:00'),
	(11, 'Pink Fluffy Unicorns Dancing On Rainbows.', 9, NULL, 'Isaac Netero', '2016-06-14 00:00:00'),
	(12, 'How will the values of Data change in the near future, in your opinion.', 10, 13, NULL, '2016-06-14 00:00:00'),
	(13, 'I find this quite accurate, but can we be guaranteed that this scheme will work for the near future?', 10, NULL, 'Pesho Peshov', '2016-06-24 00:00:00'),
	(14, '11/10 post. I have never seen a better blog post than this one.', 10, 9, NULL, '2016-07-11 00:00:00'),
	(15, 'The statistics are quite worrying.', 11, NULL, 'Isaac Netero', '2016-06-14 00:00:00'),
	(16, 'What is the best Cybercrime figting association currently existent, in your opinion?', 11, 1, NULL, '2016-06-24 00:00:00'),
	(17, 'Can you make an extended topic about all of the important features?', 12, NULL, 'Isaac Netero', '2016-06-10 00:00:00'),
	(18, 'Now this will be quite interesting to use.', 12, NULL, 'Pesho Peshov', '2016-07-11 00:00:00'),
	(19, 'I have actually met this guy in New York. It was an awesome feeling.', 12, 6, NULL, '2016-07-12 00:00:00'),
	(20, 'What will be the next era considering, the current one, and the direction it is headed?', 13, NULL, 'Isaac Netero', '2016-06-14 00:00:00'),
	(21, 'What are your assumptions of the next era?', 13, NULL, 'Pesho Peshov', '2016-06-24 00:00:00'),
	(22, 'I would like to know if you have any plans for the next era.', 13, 7, NULL, '2016-07-11 00:00:00'),
	(23, 'This was a rather fun-making post. Some of the other posts, I find, are rather booring. This one, certainly, is not.', 14, NULL, 'Pesho Peshov', '2016-06-14 00:00:00'),
	(24, 'Security has been my hobby, since my childhood. I will continue following your posts, they intrigue me.', 15, NULL, 'Isaac Netero', '2016-06-14 00:00:00'),
	(25, 'Is there any future in the machine learning. I mean, can I be sure to succeed, and earn a lot, if I concentrate in this environment.', 16, NULL, 'Isaac Netero', '2016-06-14 00:00:00'),
	(26, 'Another great post in this great blog. I am indeed, amazed by it.', 16, NULL, 'Pesho Peshov', '2016-06-24 00:00:00'),
	(27, 'This was certainly quite educational. I have learn a lot from it, and I have even started reading about these things.', 16, 3, NULL, '2016-07-11 00:00:00'),
	(28, 'I would like to see more posts about Data Protection. Keep up the posts on this topic.', 17, NULL, 'Isaac Netero', '2016-06-14 00:00:00'),
	(29, 'I am a bit negatively pointed to this post. There are some stable facts specifying that we are, indeed, in an "ice age".', 17, NULL, 'Pesho Peshov', '2016-06-14 00:00:00'),
	(30, 'What will be the outcome if these 2 principles are not well supervised.', 24, NULL, 'Isaac Netero', '2016-06-14 00:00:00'),
	(31, 'I am interested in the evolution of roboethics. What books should I read about those topics?', 26, NULL, 'Isaac Netero', '2016-06-14 00:00:00'),
	(32, 'I have been given the task to create a presentation on the same topic. May I use your posts as they are valuable information?', 26, 14, NULL, '2016-06-16 00:00:00'),
	(33, 'When will you speak about these topics at an actual conference? I\'d like to attend to it.', 26, 12, NULL, '2016-06-18 00:00:00'),
	(34, 'Very good post. Me likey.', 26, NULL, 'Pesho Peshov', '2016-07-12 00:00:00'),
	(35, 'Can you give more advices about, what it takes to be an architect?', 27, NULL, 'Isaac Netero', '2016-06-14 00:00:00'),
	(36, 'When will you speak about the Data Lakes in a more serious manner?', 27, 6, NULL, '2016-06-16 00:00:00'),
	(37, 'I am completely new to the this topic but I would like to learn a lot about these kinds of things. Can you give me a suitable source?', 27, NULL, 'Pesho Peshov', '2016-06-18 00:00:00');
/*!40000 ALTER TABLE `comments` ENABLE KEYS */;

-- Dumping structure for table javablogdb.posts
...
CREATE TABLE IF NOT EXISTS `posts` (
  ...
  CONSTRAINT `author-id` FOREIGN KEY (`author_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8;

-- Dumping data for table javablogdb.posts: ~32 rows (approximately)
DELETE FROM `posts`;
...
-- Dumping structure for table javablogdb.posts_tags
DROP TABLE IF EXISTS `posts_tags`;
CREATE TABLE IF NOT EXISTS `posts_tags` (
  `post_id` int(11) NOT NULL,
  `tags_id` int(11) NOT NULL,
  PRIMARY KEY (`post_id`,`tags_id`),
  KEY `FK79lx4quime8ct09nbmmf6wuao` (`tags_id`),
  CONSTRAINT `FK79lx4quime8ct09nbmmf6wuao` FOREIGN KEY (`tags_id`) REFERENCES `tags` (`id`),
  CONSTRAINT `FKcreclgob71ibo58gsm6l5wp6` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table javablogdb.posts_tags: ~92 rows (approximately)
...
-- Dumping structure for table javablogdb.tags
...
-- Dumping data for table javablogdb.tags: ~39 rows (approximately)
DELETE FROM `tags`;
...
-- Dumping structure for table javablogdb.users
...
-- Dumping data for table javablogdb.users: ~15 rows (approximately)
DELETE FROM `users`;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `username`, `fullname`, `passwordhash`) VALUES
	...
	(5, 'stamat', NULL, '56c28f25a1ba1cfddb6403d3dd546a8c'),
